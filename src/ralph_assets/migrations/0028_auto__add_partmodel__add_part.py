...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PartModel'
        db.create_table('ralph_assets_partmodel', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('model_type', self.gf('django.db.models.fields.PositiveSmallIntegerField')()),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=150)),
        ))
        db.send_create_signal('ralph_assets', ['PartModel'])

        # Adding model 'Part'
        db.create_table('ralph_assets_part', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
            ('cache_version', self.gf('django.db.models.fields.PositiveIntegerField')(default=0)),
            ('asset', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'parts', null=True, to=orm['ralph_assets.Asset'])),
            ('asset_type', self.gf('django.db.models.fields.PositiveSmallIntegerField')()),
            ('model', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ralph_assets.PartModel'], null=True, on_delete=models.PROTECT)),
            ('sn', self.gf('django.db.models.fields.CharField')(unique=True, max_length=200)),
            ('order_no', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ...
            ('part_environment', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['cmdb.CI'], null=True, on_delete=models.PROTECT)),
            ('warehouse', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ralph_assets.Warehouse'], on_delete=models.PROTECT)),
        ))
        db.send_create_signal('ralph_assets', ['Part'])


    def backwards(self, orm):
        # Deleting model 'PartModel'
        db.delete_table('ralph_assets_partmodel')

        # Deleting model 'Part'
        db.delete_table('ralph_assets_part')
    ...
    models = {
        ...
        'ralph_assets.part': {
            ...
            'asset': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "u'parts'", 'null': 'True', 'to': "orm['ralph_assets.Asset']"}),
            'asset_type': ('django.db.models.fields.PositiveSmallIntegerField', [], {}),
            'cache_version': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'model': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['ralph_assets.PartModel']", 'null': 'True', 'on_delete': 'models.PROTECT'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'order_no': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'part_environment': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['cmdb.CI']", 'null': 'True', 'on_delete': 'models.PROTECT'}),
        ...
        'ralph_assets.partmodel': {
            'Meta': {'object_name': 'PartModel'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'model_type': ('django.db.models.fields.PositiveSmallIntegerField', [], {}),
