...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('ralph_assets_part', 'model_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ralph_assets.PartModel'], null=True, on_delete=models.PROTECT))

    def backwards(self, orm):

        # Changing field 'Part.model'
        db.alter_column('ralph_assets_part', 'model_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['ralph_assets.PartModel'], on_delete=models.PROTECT))
