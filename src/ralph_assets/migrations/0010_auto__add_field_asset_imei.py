...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Asset.imei'
        db.add_column('ralph_assets_asset', 'imei',
                      self.gf('django.db.models.fields.URLField')(max_length=18, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Asset.imei'
        db.delete_column('ralph_assets_asset', 'imei')
    ...
    models = {
        ...
        'ralph_assets.asset': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'imei': ('django.db.models.fields.URLField', [], {'max_length': '18', 'null': 'True', 'blank': 'True'}),
            ...
            'task_link': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
