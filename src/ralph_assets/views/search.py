...
class AssetSearchDataTable(_AssetSearch, DataTableMixin):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.columns = [
            ...
            _('Data center', field='device_info__data_center__name',
              export=True, show_conditions=show_dc),
            _('Server room', field='device_info__server_room__name',
              export=True, show_conditions=show_dc),
            _('Rack', field='device_info__rack__name', export=True,
              show_conditions=show_dc),
            _('Orientation', field='device_info__orientation', export=True,
              show_conditions=show_dc),
            _('Position', field='device_info__position', export=True,
              show_conditions=show_dc),
            _('Slot number', field='device_info__slot_no', export=True,
              show_conditions=show_dc),
            ...
            _('SN', field='sn', sort_expression='sn', bob_tag=True,
              export=True),
            _('Service Catalog', field='service__name', export=True,
              show_conditions=show_dc),
            _('Environment', field='device_environment__name', export=True,
              show_conditions=show_dc),
